...
class UserProfileModelTest(TestCase):
    def setUp(self):
        ...
        self.profile_data = {"user": self.user, "avatar": "images/avatars/test.jpg"}
    ...
    def test_default_avatar(self):
        ...
        self.assertEqual(new_profile.avatar.name, "images/avatars/default.png")
    ...
    def test_verbose_name_plural(self):
        ...
        self.assertEqual(UserProfile._meta.verbose_name_plural, "UserProfiles")

    def test_string_representation(self):
        """Test the __str__ method returns the correct format"""
        expected_str = (
            f"Username: {self.user.username} Avatar: {self.profile.avatar.name}"
        )
